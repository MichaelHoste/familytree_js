...
(function() {
  ...
  this.FamilyTree = (function() {
    ...
    FamilyTree.prototype.bindMenu = function() {
      ...
      createFirstPerson = (function(_this) {
      ...
      $('#family-tree-panel').on('click', 'button[data-action="add-man"]', (function(_this) {
        return function() {
          var name;
      ...
      $('#family-tree-panel').on('click', 'button[data-action="add-woman"]', (function(_this) {
        return function() {
          var name;
      ...
      $('#family-tree-panel').on('click', 'button[data-action="remove"]', (function(_this) {
        return function(event) {
          var j, len, oldRoot, partnerRelation, ref;
      ...
      return $('#family-tree-panel').on('click', 'button[data-action="remove-couple"]', (function(_this) {
        return function(event) {
          var child, j, len, oldRoot, ref;
          if (confirm(_this.t("Remove couple?", "Supprimer le couple ?"))) {
            _this.cleanTree();
            _this.people = _.without(_this.people, _this.root);
            _this.people = _.without(_this.people, _this.root.partners()[0]);
            ref = _this.root.partnerRelations[0].children;
            for (j = 0, len = ref.length; j < len; j++) {
              child = ref[j];
    ...
    FamilyTree.prototype.refreshMenu = function() {
      var coupleHasNoParents, daughterCaption, j, len, partner, ref, sonCaption;
